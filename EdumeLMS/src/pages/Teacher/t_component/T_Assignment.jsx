...
function T_Assignment() {
  ...
  const submitImage = async (e) =>{
    ...
    try {
      await axios.post('http://localhost:3002/Assignment/upload', formData,  {
          headers: {
    ...
    return (
      ...
      <div className='App min-h-screen'>
        ...
        <div className='pdf flex justify-center m-16 text-lg'>Upload Assignments and Quizes</div>

        <form className='formStyle' onSubmit={submitImage}>

          {/* description textarea */}
          <div className="col-span-full flex justify-center mb-6">
          <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900"> Description  :</label>
          <textarea value={title} onChange={(e) => setTitle(e.target.value)}  type='text' className='resize title form-control p-1 ml-4 border-2 border-gray-300 rounded-lg' placeholder='Title'/>
          </div>
